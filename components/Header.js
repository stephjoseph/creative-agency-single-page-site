...
const Header = () => {
  ...
  useEffect(() => {
    ...
    gsap.fromTo(
      textRef.current,
      { opacity: 0 },
      { opacity: 1, duration: 1.5, delay: 0.3, ease: 'easeIn' }
    );
  }, []);
  return (
    <header className='flex w-full flex-col items-center pt-[68.27%] pb-24 md:pt-[4.813rem] md:pb-[9.375rem] xl:pt-[7rem] xl:pb-[10rem]'>
      <div className='flex w-[87.2%] flex-col gap-10 md:w-[89.71%]  md:gap-8 xl:w-[77.08%] xl:gap-12'>
        <div className='flex w-full flex-col gap-[0.938rem] md:w-[57.76%] md:gap-8 xl:w-[64%] xl:gap-10'>
          <h1
            ref={headingRef}
            className='font-h1 xl:font-h1 text-[2.5rem] leading-[2.5rem] text-black md:text-[3.5rem] md:leading-[3.5rem]'
          >
            Branding & website design agency
          </h1>
          <p
            ref={textRef}
            className='font-body xl:font-body text-[0.938rem] leading-[1.563rem] text-black xl:w-[76.06%]'
          >
